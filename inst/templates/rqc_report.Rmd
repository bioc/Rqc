...
## Average Quality by Tile and Lanes
This plot describes the average quality by each tile and lanes.
```{r tile-average-quality-plot, fig.width=10, fig.path=figDir, dev='pngnox11', fig.ext='png'}
rqcTileQualityPlot(rqcResultSet)
```
